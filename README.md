...
To build the final jar and optimize the golfApplication application for production, run:
...
Then navigate to [http://localhost:8887](http://localhost:8887) in your browser.
