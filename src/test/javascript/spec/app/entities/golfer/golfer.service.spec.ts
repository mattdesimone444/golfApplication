...
describe('Service Tests', () => {
  describe('Golfer Service', () => {
    let injector: TestBed;
    let service: GolferService;
    let httpMock: HttpTestingController;
    let elemDefault: IGolfer;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Golfer', async () => {
      ...
      it('should update a Golfer', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            height: 1,
      ...
      it('should return a list of Golfer', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            height: 1,
      ...
      it('should delete a Golfer', async () => {
